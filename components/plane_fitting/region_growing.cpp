...
*/
  ...
  for (i = 0; i < clusters.size(); i++) {
	  ...
	  /*plane fitting here on *newCloud and *newNormals
	  outside loop, add an empty mesh that we add the planes to*/

	  //Extracting the plane equation coefficients for each cluster
